...
export default async function handler(
    ...
    if (prompt.includes("analyze my bets")) {
        // res.status(200).json( {answer: "fuck you"} )
        // Have very rigid instructions for the input. Robustness IS NOT the priority anymore
